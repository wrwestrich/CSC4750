...
void BasicObject::render(Pixel* pix, Matrix* zBuffer, Matrix* W, Matrix* transform, Color* mat,
                         ...
                         Texture* tex, unsigned char* textureColors)
{
   ...
   {
      Face* face = faceIter->next();
      face->render(pix, zBuffer, W, transform, mat, lightPoint, ambLight, E, attn, shine, tex, textureColors);
   }
