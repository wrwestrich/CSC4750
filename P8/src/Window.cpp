...
Window::Window(int argc, char** argv, int width, int height, int xLoc, int yLoc, const char* title)
{
   ...
   const char* fileName1 = "../shaders/vertex_shader_bumpmap.txt";  
   //const char* fileName1 = "../shaders/shader_bump_vertex.glsl";
   ...
   const char* fileName2 = "../shaders/fragment_shader_bumpmap.txt";
   //const char* fileName2 = "../shaders/shader_bump_fragment.glsl";  
   ...
   const char* fileName3 = "../shaders/geometry_shader_bumpmap.txt";
   //const char* fileName3 = "../shaders/shader_bump_geometry.glsl";
   ...
   GLint textureLoc = glGetUniformLocation(program, "colorMap");
