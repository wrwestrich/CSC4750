...
//{
	...
	ReadFile* file = new ReadFile("fov.txt");
	...
	InstanceObject* instance = new InstanceObject(sphere);
	
	buildInstance(instance, new ReadFile("trs.txt"));
